<nav class="bg-transparent sticky w-full z-20 top-0 start-0">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-3">
      ...
      <div class="flex flex-1 md:flex-none md:order-2 justify-end space-x-3 rtl:space-x-reverse">
        <a href="{{$page->baseUrl}}/contact" target="_blank">
        <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 hidden  md:flex">Contact Us</button>
        </a>
