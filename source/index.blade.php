...
<section class="bg-[#ddd1ae] py-10">
    <div class="max-w-7xl mx-auto px-6 md:px-12 text-center">
      ...
      <div class="flex flex-wrap justify-center items-center gap-8 md:gap-16">
        <img src="{{$page->baseUrl}}/assets/images/company/1.png" alt="1 hello" class="h-20 object-contain mix-blend-color-burn   md:h-16">
        <img src="{{$page->baseUrl}}/assets/images/company/2.jpg" alt="2 Shubham" class="h-20  mix-blend-color-burn  md:h-16">
